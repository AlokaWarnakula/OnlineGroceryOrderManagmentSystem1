...
public class CartServlet extends HttpServlet {
    ...
    private static final String CART_FILE = "D:\\OnlineGroceryOrderManagmentSystem-master\\src\\main\\webapp\\data\\items.txt";
    private MergeServlet mergeServlet; // Instance of MergeServlet

    @Override
    public void init() throws ServletException {
        File dataDir = new File("D:\\OnlineGroceryOrderManagmentSystem-master\\src\\main\\webapp\\data\\");
        if (!dataDir.exists()) {
            if (dataDir.mkdirs()) {
