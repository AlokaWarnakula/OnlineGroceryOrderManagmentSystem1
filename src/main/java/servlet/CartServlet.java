...
public class CartServlet extends HttpServlet {
    private static final String ITEMS_FILE = "/Users/jayashanguruge/Desktop/OnlineGroceryOrderSystem/src/main/webapp/data/items.txt";
    private static final String CART_FILE = "/Users/jayashanguruge/Desktop/OnlineGroceryOrderSystem/src/main/webapp/data/cart.txt";
    private MergeServlet mergeServlet; // Instance of MergeServlet

    @Override
    public void init() throws ServletException {
        File dataDir = new File("/Users/jayashanguruge/Desktop/OnlineGroceryOrderSystem/src/main/webapp/data");
        if (!dataDir.exists()) {
            if (dataDir.mkdirs()) {
